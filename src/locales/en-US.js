export default {
  ...
  outlookManager: {
    ...
    oauth: {
      ...
      tabOAuth: 'OAuth Login',
      clientIdRequired: 'Azure AD Client ID is required to use OAuth login.',
      clientIdHelp: 'How to get Client ID',
      save: 'Save',
      customClientId: 'Custom Client ID',
      clear: 'Clear',
      step1Desc: 'Click the button below to generate a Microsoft authorization link. Log in with your Microsoft account in the browser to authorize.',
      generating: 'Generating...',
      generateAuthLink: 'Generate Auth Link',
      step2Desc: 'Open the link below in your browser and log in with your Microsoft account. After authorization, paste the full URL from the browser address bar below.',
      copyLink: 'Copy Link',
      callbackUrlLabel: 'Callback URL after authorization',
      callbackUrlPlaceholder: 'Paste the full URL from your browser after authorization...',
      back: 'Back',
      fetching: 'Fetching...',
      getToken: 'Get Token',
      ...
      generateFailed: 'Failed to generate auth link: {error}',
      fetchTokenFailed: 'Failed to get token: {error}',
      saveFailed: 'Save failed: {error}',
      addSuccess: 'Account {email} added successfully',
      helpTitle: 'How to Get Azure AD Client ID',
      helpStep1Before: 'Open ',
      helpStep1After: ', click "New registration".',
      invalidClientId: 'Invalid Client ID format, please enter a valid UUID',
      clientIdNotConfigured: 'OAuth Client ID is not configured. Please set it in settings or use manual import.',
      helpStep2Title: 'Fill in the application information:',
      helpStep2Name: 'Name: any, e.g.',
      helpStep2AccountType: 'Supported account types: select "Accounts in any organizational directory and personal Microsoft accounts"',
      helpStep2RedirectUri: 'Redirect URI: after registration, open Authentication → Add a platform → Mobile and desktop applications (do not use Web), then add:',
      helpStep3: 'After clicking "Register", copy "Application (client) ID" from the overview page. This is your Client ID.',
      helpStep4: 'Go to "API permissions" in the left menu, add the following Microsoft Graph delegated permissions:',
      helpStep5: 'Go to "Authentication": confirm the mobile/desktop redirect URI above is added; then enable "Allow public client flows" at the bottom and save.',
      gotIt: 'Got it',
      oauthStateMismatch: 'OAuth state verification failed. Please restart the authorization flow.',
      oauthStateMissing: 'OAuth state parameter is missing from the callback URL. Please retry.'
    }
  },
  databaseConfig: {
  ...
  tokenList: {
    ...
    tutorial: {
      tooltip: 'Token Tutorial',
      title: 'How to Get a Token',
      description: 'Follow these steps to obtain an Augment API Token:',
      step1: 'Log in to the Augment website',
      step2: 'Open the Personal API Tokens settings page',
      openLink: 'Open Link',
      step2Tip: 'If the page doesn\'t load, try visiting',
      step2TipLink: 'Code Review Settings',
      step3: 'Create a new Token',
      step4: 'Manually copy the URL and Token, or export as a JSON file and import',
      understood: 'Got It'
    },
    ...
    importAccountsSuccess: 'Successfully imported {count} accounts',
    importFileInvalid: 'Invalid JSON file format',
    importDialog: {
      title: 'Import Augment Accounts',
      info: 'Import Augment accounts from a JSON file. Only accessToken and tenantURL fields are used. Supports single object or object array.',
      formatExample: 'Format Example',
      selectFile: 'Select File',
      clickToSelect: 'Click to select a JSON file',
      supportFormat: 'Supports single JSON object or object array',
      reselect: 'Reselect',
      previewTitle: 'Preview ({count} items)',
      resultTitle: 'Import Result',
      resultSummary: 'Success {success} / Skip {skip} / Failed {failed} / Total {total}',
      import: 'Import ({count})',
  ...
  tokenCard: {
    ...
    checkDisabled: 'Check disabled, enable from More menu',
  ...
  messages: {
    ...
    checkIsDisabled: 'Check is disabled for this account, enable from More menu',
  ...
  cursorUsage: {
    ...
    tabCharts: 'Charts',
    chartTrend: 'Cost / Token Trend',
    chartModelDist: 'Model Usage Distribution',
    chartModelCost: 'Model Token Comparison',
  ...
  gptMailManager: {
    ...
    apiKeyLabel: 'API Key',
    apiKeyReset: 'Reset',
    apiKeyHint: 'Get API Key:',
    usageTitle: 'API Quota',
    usageTotal: 'Total {used}/{limit}',
    usageRemainingLabel: 'Remaining count',
    usageTotalLabel: 'Total',
    usageUnlimited: 'Unlimited',
    usageNA: '-',
    tabMail: 'Mail',
    tabHistoryEmails: 'Email history',
    historyEmpty: 'No email history yet',
    historyCreatedAt: 'Created at',
    historyEmail: 'Email',
    historyTag: 'Tag',
    historyDescription: 'Description',
    historyLabel: 'Label',
    historyFetchMail: 'Fetch mail',
    historyDelete: 'Delete',
    historySearchPlaceholder: 'Search email, tag, description',
    historyDeleteConfirm: 'Are you sure you want to delete this email record?',
  ...
  platform: {
    ...
    cursor: {
      ...
      accountCount: '{count} accounts',
      batchRefreshQuota: 'Batch Refresh Page Quota',
      refreshQuota: 'Refresh Quota',
      addAccount: 'Add Account',
      currentAccount: 'Current Account',
      switching: 'Switching...',
      ...
      permission: {
        ...
        description: 'Switching accounts and managing updates requires modifying Cursor files. Please find this app in macOS "System Settings > Privacy & Security > App Management" and enable the permission. After granting it, click "Recheck"; if it still does not work, fully quit and reopen this app, then try again.',
    ...
    openai: {
      ...
      exportSuccess: 'Accounts exported successfully',
      exportFailed: 'Export failed',
      exportSavedHint: 'File saved to default download directory',
      filter: {
        all: 'All',
        active: 'Active',
        expired: 'Expired',
      ...
      codexDialog: {
        ...
        tabModelUsage: 'Model Token Usage',
        tabRequestLogs: 'Request Logs',
        serviceStatus: 'Codex Route Status',
        running: 'Enabled',
        stopped: 'Disabled',
        refresh: 'Refresh',
        startService: 'Enable Route',
        stopService: 'Disable Route',
        serverUrl: 'Server URL',
        apiKey: 'API Key',
        poolStrategy: 'Pool Strategy',
        strategyRoundRobin: 'Round Robin',
        strategyRoundRobinDesc: 'Rotate per request, evenly distributed',
        strategySingle: 'Single',
        strategySingleDesc: 'Use a fixed account',
        strategySmart: 'Smart',
        strategySmartDesc: 'Weighted random by quota & expiry',
        selectAccount: 'Select Account',
        noMatchingAccounts: 'No matching accounts',
        totalAccounts: 'Total Accounts',
        apiKeyPlaceholder: 'Enter API Key (required)',
        showApiKey: 'Show',
        hideApiKey: 'Hide',
        ...
        unsavedChangesHint: 'API key changed but not saved yet',
        totalAccounts: 'Total Accounts',
        ...
        prevPage: 'Previous',
        nextPage: 'Next',
        saveConfigSuccess: 'Codex config saved',
        saveConfigFailed: 'Failed to save config: {error}',
        startSuccess: 'Codex route enabled',
