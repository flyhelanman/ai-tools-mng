export default {
  ...
  outlookManager: {
    ...
    oauth: {
      tabManual: '手动导入',
      tabOAuth: 'OAuth 授权',
      clientIdRequired: '需要配置 Azure AD Client ID 才能使用 OAuth 授权登录。',
      clientIdHelp: '获取 Client ID 帮助',
      save: '保存',
      customClientId: '自定义 Client ID',
      clear: '清除',
      step1Desc: '点击下方按钮生成微软授权链接，在浏览器中登录微软账号完成授权。',
      generating: '生成中...',
      generateAuthLink: '生成授权链接',
      step2Desc: '请在浏览器中打开以下链接，登录微软账号并授权。授权完成后，将浏览器地址栏中的完整 URL 粘贴到下方。',
      copyLink: '复制链接',
      callbackUrlLabel: '授权后的回调 URL',
      callbackUrlPlaceholder: '粘贴授权完成后浏览器地址栏中的完整 URL...',
      back: '返回',
      fetching: '获取中...',
      getToken: '获取 Token',
      tokenSuccess: 'Token 获取成功',
      emailLabel: '邮箱',
      enterEmail: '请输入邮箱地址',
      reauth: '重新授权',
      saveAccount: '保存账户',
      generateFailed: '生成授权链接失败: {error}',
      fetchTokenFailed: '获取 Token 失败: {error}',
      saveFailed: '保存失败: {error}',
      addSuccess: '账号 {email} 添加成功',
      helpTitle: '如何获取 Azure AD Client ID',
      helpStep1Before: '打开 ',
      helpStep1After: '，点击「新注册」。',
      invalidClientId: 'Client ID 格式不正确，请输入有效的 UUID',
      clientIdNotConfigured: 'OAuth Client ID 未配置，请在设置中填写或使用手动导入方式',
      helpStep2Title: '填写应用信息：',
      helpStep2Name: '名称：任意，例如',
      helpStep2AccountType: '支持的账户类型：选择「任何组织目录中的帐户和个人 Microsoft 帐户」',
      helpStep2RedirectUri: '重定向 URI：注册完成后在「身份验证」中点击「添加平台」，选择「移动和桌面应用程序」（不要使用「Web」），添加：',
      helpStep3: '点击「注册」完成后，在应用概览页复制「应用程序(客户端) ID」，即为 Client ID。',
      helpStep4: '在左侧菜单进入「API 权限」，添加以下 Microsoft Graph 委托权限：',
      helpStep5: '在左侧菜单进入「身份验证」：确认已按上一步添加「移动和桌面应用程序」重定向；底部勾选「允许公共客户端流」并保存。',
      gotIt: '我知道了',
      oauthStateMismatch: 'OAuth 状态校验失败，请重新发起授权流程。',
      oauthStateMissing: '回调 URL 中缺少 OAuth 状态参数，请重试。'
    }
  },
  databaseConfig: {
    title: '数据库配置',
  ...
  tokenList: {
    ...
    tutorial: {
      tooltip: 'Token 获取教程',
      title: 'Token 获取教程',
      description: '按照以下步骤获取 Augment API Token：',
      step1: '登录 Augment 官网',
      step2: '打开 Personal API Tokens 设置页面',
      openLink: '点击打开',
      step2Tip: '如果页面打不开，可尝试先访问',
      step2TipLink: 'Code Review 设置页',
      step3: '创建一个新的 Token',
      step4: '手动复制 URL 和 Token 添加，或者导出为 JSON 文件后再导入',
      understood: '我知道了'
    },
    batchImport: '批量导入',
    ...
    batchRefreshSessionSelected: '批量刷新 Session',
    ...
    batchRefreshingSessions: '正在刷新 {count} 个 Session...',
    ...
    fullSync: '全量同步',
    importAccounts: '导入帐号',
    importAccountsSuccess: '成功导入 {count} 个帐号',
    importFileInvalid: 'JSON 文件格式无效',
    importDialog: {
      title: '导入 Augment 帐号',
      info: '从 JSON 文件导入 Augment 帐号。仅使用 accessToken 与 tenantURL 字段，支持单个对象或对象数组。',
      formatExample: '格式示例',
      selectFile: '选择文件',
      clickToSelect: '点击选择 JSON 文件',
      supportFormat: '支持单个 JSON 对象或对象数组',
      reselect: '重新选择',
      previewTitle: '预览（共 {count} 条）',
      resultTitle: '导入结果',
      resultSummary: '成功 {success} / 跳过 {skip} / 失败 {failed} / 共 {total}',
      import: '导入 ({count})',
      emptyFile: '文件内容为空或没有有效的帐号数据',
  ...
  messages: {
    ...
    checkDisabled: '已禁用检测',
    checkEnabled: '已启用检测',
    checkIsDisabled: '该账号已禁用检测，请在更多菜单中启用',
  ...
  cursorUsage: {
    ...
    noEvents: '暂无使用记录',
    tabCharts: '图表',
    chartTrend: '费用 / Token 趋势',
    chartModelDist: '模型使用占比',
    chartModelCost: '模型 Token 对比',
    billingCycle: '账期',
    byModel: '按模型',
    allData: '全部数据',
    allDataRange: '全部历史数据'
  ...
  gptMailManager: {
    ...
    apiKeyLabel: 'API Key',
    apiKeyReset: '重置',
    apiKeyHint: '获取 API Key：',
    usageTitle: 'API 额度',
    usageTotal: '总计 {used}/{limit}',
    usageRemainingLabel: '剩余次数',
    usageTotalLabel: '共',
    usageUnlimited: '无限制',
    usageNA: '-',
    tabMail: '邮件',
    tabHistoryEmails: '历史邮箱',
    historyEmpty: '暂无历史邮箱',
    ...
    historyFetchMail: '收件',
    historyDelete: '删除',
    historySearchPlaceholder: '搜索邮箱、标签、描述',
    historyDeleteConfirm: '确定要删除该邮箱记录吗？',
    updateSuccess: '更新成功'
  },
  hmeManager: {
    title: 'iCloud HME',
  ...
  platform: {
    ...
    cursor: {
      ...
      permission: {
        title: '需要授予应用管理权限',
        description: '切换账号和管理更新需要修改 Cursor 的文件，请在 macOS「系统设置 > 隐私与安全性 > 应用管理」中找到本应用并开启权限；开启后请点击「重新检测」，若仍无效请完全退出并重新打开本应用后再试。',
        openSettings: '打开系统设置',
        recheck: '重新检测',
        granted: '权限已获取',
    ...
    openai: {
      ...
      codexDialog: {
        ...
        title: 'Codex API 服务',
        tabOverview: '总览',
        tabModelUsage: '模型 Token 使用',
        tabRequestLogs: '请求日志',
        serviceStatus: 'Codex 路由状态',
        running: '已启用',
        stopped: '已禁用',
        refresh: '刷新',
        startService: '启用路由',
        ...
        strategyRoundRobinDesc: '逐请求轮换，均匀分配到每个账号',
        strategySingle: '单个',
        strategySingleDesc: '固定使用指定账号',
        strategySmart: '智能',
        strategySmartDesc: '按配额和到期时间加权随机分配',
        selectAccount: '选择账号',
        noMatchingAccounts: '无匹配账号',
        totalAccounts: '总账号',
        apiKeyPlaceholder: '请输入 API 密钥（必填）',
        showApiKey: '显示',
        hideApiKey: '隐藏',
        generateApiKey: '生成',
        generateApiKeySuccess: '已生成新的 API Key',
        apiKeyRequired: '请先设置 API Key',
        copyEmpty: '没有可复制的内容',
        saveConfig: '保存配置',
        unsavedChangesHint: 'API Key 已修改但尚未保存',
        totalAccounts: '总账号',
        totalRequests: '累计请求数',
        ...
        prevPage: '上一页',
        nextPage: '下一页',
        saveConfigSuccess: 'Codex 配置已保存',
        saveConfigFailed: '保存配置失败: {error}',
        startSuccess: 'Codex 路由已启用',
